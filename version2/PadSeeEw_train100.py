...
checkpoint = ModelCheckpoint('PadSeeEw_best100.h5', verbose=1, monitor='val_mean_absolute_error',save_best_only=True, mode='min')
...
#Test Model
model = load_model('PadSeeEw_best100.h5')
